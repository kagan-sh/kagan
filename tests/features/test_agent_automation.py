...
class TestAgentSpawning:
    ...
    async def test_pair_ticket_not_auto_spawned(self, state_manager: StateManager, git_repo: Path):
    ...
    async def test_manual_spawn_for_auto_ticket(self, state_manager: StateManager, git_repo: Path):
...
class TestAgentStopping:
    ...
    async def test_stop_running_agent(self, state_manager: StateManager):
    ...
    async def test_stop_nonexistent_returns_false(self, state_manager: StateManager):
    ...
    async def test_moving_out_of_in_progress_stops_agent(self, state_manager: StateManager):
...
class TestIterationLoop:
    ...
    async def test_complete_signal_moves_to_review(
        self, state_manager: StateManager, git_repo: Path, mock_agent_factory
    ):
...
class TestSchedulerQueue:
    ...
    async def test_events_processed_in_order(self, state_manager: StateManager):
    ...
    async def test_scheduler_start_idempotent(self, state_manager: StateManager):
...
class TestSessionManagement:
    ...
    async def test_create_session_for_pair_ticket(
        self, state_manager: StateManager, git_repo: Path, mock_tmux
    ):
...
class TestCapacityManagement:
    ...
    async def test_waiting_tickets_processed_when_capacity_frees(
        ...
        await state_manager.create_ticket(waiting)
    ...
    async def test_get_running_agent_returns_agent(self, state_manager: StateManager):
    ...
    async def test_get_iteration_count(self, state_manager: StateManager):
    ...
    async def test_reset_iterations(self, state_manager: StateManager):
