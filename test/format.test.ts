...
describe("stripSubagentSuffix", () => {
  test("removes the subagent parenthetical", () => {
    expect(stripSubagentSuffix("Review i18n a11y (@general subagent)")).toBe("Review i18n a11y")
  })

  test("leaves titles without a suffix unchanged", () => {
    expect(stripSubagentSuffix("Plain title")).toBe("Plain title")
  })
})
