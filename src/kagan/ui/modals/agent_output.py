...
if TYPE_CHECKING:
    ...
    from kagan.database.models import AgentLogEntry, Ticket
...
class AgentOutputModal(ModalScreen[None]):
    ...
    def __init__(
        ...
        historical_logs: dict[str, list[AgentLogEntry]] | None = None,
        **kwargs,
    ) -> None:
    ...
    async def _load_historical_log(
        self, output: StreamingOutput, log_entry: AgentLogEntry, show_iteration_header: bool = True
    ) -> None:
